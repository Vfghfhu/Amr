...
if 'pass' in ah :
	...
	import requests
	from requests.structures import CaseInsensitiveDict
	url = "https://mab.etisalat.com.eg:11003/Saytar/rest/downloadAndGet/submitOrder"
	headers = CaseInsensitiveDict()
	headers["applicationVersion"] = "2"
	headers["applicationName"] = "MAB"
	...
	headers["ADRUM_1"] = "isMobile:true"
	headers["ADRUM"] = "isAjax:true"
	data = "<?xml version='1.0' encoding='UTF-8' standalone='yes' ?><downloadAndGetSubmitOrderRequest><Parameters><Parameter><name>GIFT_ID</name><value>DIGITAL_GAMING_GIFT</value></Parameter><Parameter><name>VALIDITY</name><value>2</value></Parameter><Parameter><name>AMOUNT</name><value>2000</value></Parameter><Parameter><name>VERSION_NUMBER</name><value>20.19.0</value></Parameter><Parameter><name>SERVICE_CLASS_GROUP</name><value>Smart 1 RP</value></Parameter></Parameters><dial>"+num+"</dial><operationId>REDEEM</operationId><productId>DOWNLOAD_AND_PICK_GAMING</productId></downloadAndGetSubmitOrderRequest>"
